...
import '21.medical_kyc_success.dart';

class MedicalKyc3 extends StatefulWidget {
  const MedicalKyc3({Key? key}) : super(key: key);

  @override
  State<MedicalKyc3> createState() => _MedicalKyc3State();
}

class _MedicalKyc3State extends State<MedicalKyc3> {
