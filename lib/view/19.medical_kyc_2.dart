...
import '20.medical_kyc_3.dart';

class MedicalKyc2 extends StatefulWidget {
  const MedicalKyc2({Key? key}) : super(key: key);

  @override
  State<MedicalKyc2> createState() => _MedicalKyc2State();
}

class _MedicalKyc2State extends State<MedicalKyc2> {
  final picker = ImagePicker();
  File? _image;

  Future pickedImage() async {
    final imagePicked = await picker.getImage(source: ImageSource.camera);
